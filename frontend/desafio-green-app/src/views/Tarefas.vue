<template>
    <div id="entrada-area">
        ...
        <div v-if="tasks.length === 0">Não há tarefas para hoje.</div>
        ...
        const fetchTasks = async () => {
            ...
            try {
                ...
                tasks.value = tasks.value.filter(task => {
                    ...
                    return taskDate.toLocaleDateString('pt-BR') === today.toLocaleDateString('pt-BR');
                });


                tasks.value.forEach(task => {
                    const taskDate = new Date(task.due_date);
                    task.due_date = taskDate.toLocaleDateString('pt-BR');
                });
            } catch (err) {
